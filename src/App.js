...
//         if (!formData.source || !formData.destination || !formData.duration || !formData.budget) {
...
//         try {
//             const response = await axios.post('https://trialdeployment.onrender.com/generate_itinerary', formData);
...
//         setIsLoading(true);
//         try {
//             const response = await axios.get('https://trialdeployment.onrender.com/download_pdf', {
//                 responseType: 'blob',
//             });
...
//                     <input type="number" id="duration" name="duration" placeholder="Enter duration" onChange={handleChange} required />
//                 </div>
...
// // import React, { useState } from 'react';
// // import axios from 'axios';
// // import './App.css'; // Ensure your CSS file is updated for styling
...
// //     return (
// //         <div className="app-container">
// //             <h1 className="app-title">Travel Itinerary Generator</h1>
            
// //             <form onSubmit={handleSubmit} className="itinerary-form">
// //                 <div className="form-group">
// //                     <input type="text" id="source" name="source" placeholder="Source" onChange={handleChange} required />
// //                 </div>
                
// //                 <div className="form-group">
// //                     <input type="text" id="destination" name="destination" placeholder="Destination" onChange={handleChange} required />
// //                 </div>
                
// //                 <div className="form-group">
// //                     <input type="number" id="duration" name="duration" placeholder="Duration (days)" onChange={handleChange} required />
// //                 </div>
                
// //                 <div className="form-group">
// //                     <input type="number" id="budget" name="budget" placeholder="Budget (in ₹)" onChange={handleChange} required />
// //                 </div>
                
// //                 <div className="form-group">
// //                     <textarea id="preferences" name="preferences" placeholder="Preferences (comma-separated)" onChange={handleChange} />
// //                 </div>
...
// //                     <h2>Your Itinerary:</h2>
// //                     <pre>{itinerary}</pre>
// //                     <button onClick={handleDownloadPdf} className={`download-button ${isLoading ? 'loading' : ''}`} disabled={isLoading}>
// //                         {isLoading ? 'Downloading...' : 'Download PDF'}
// //                     </button>
// //                 </div>
// //             )}
